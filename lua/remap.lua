...
vim.keymap.set('n', '<F6>', ':JupyniumLoadFromIpynbTab 2<CR>',
  { silent = true, noremap = true, desc = 'Load from IPYNB in Tab 2' })
vim.keymap.set('n', '<F7>', ':JupyniumLoadFromIpynbTab 3<CR>',
  { silent = true, noremap = true, desc = 'Load from IPYNB in Tab 3' })
vim.keymap.set('n', '<F8>', ':JupyniumLoadFromIpynbTab 4<CR>',
...
function ToggleTerminal()
  if gotoid(te_win_id) == 1 then
    ...
    openTerminal('8', 'horizontal') -- Default size and direction if not specified
  end
end
