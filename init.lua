...
require('lazy').setup({
  ...
  {
    -- Autocompletion, snippet Engine, LSP completion & user friendly snippets
    'hrsh7th/nvim-cmp',
    dependencies = {
      'L3MON4D3/LuaSnip',
  ...
  },
  {
    ...
    enabled = vim.fn.isdirectory(vim.fn.expand "~/miniconda3/envs/myenv"),
...
local servers = {
  -- clangd = {}, html = { filetypes = { 'html', 'twig', 'hbs'} },
  pyright = {
    filetypes = { "python" }
  },
